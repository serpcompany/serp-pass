...
| Cloudflare staging | deployed and passed | Worker version `7db52d3c-7903-497c-a0b9-19d2f3d49378`, isolated APAC D1, health `200 ready`, and all 25 migrations current. Real Stripe Checkout/Portal/Event projection, real paid extension activation, real-receipt Allocation, Operator-only Payment route, and simplified Publisher UI pass. Connect onboarding and Stripe Transfers are disabled. The real `$7` Earning correctly remains accrued with zero Payment rows. |
